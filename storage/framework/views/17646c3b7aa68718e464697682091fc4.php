...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label', 'value', 'icon' => null]));
...
foreach (array_filter((['label', 'value', 'icon' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/components/ui/stat-card.blade.php ENDPATH**/ ?>